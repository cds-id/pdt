    ...
    <div className="flex min-h-screen items-center justify-center bg-pdt-accent px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-pdt-primary/70">
        ...
        <div className="rounded-xl border-2 border-pdt-primary/10 bg-pdt-primary p-6 shadow-xl sm:p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-pdt-accent font-semibold text-pdt-primary hover:bg-pdt-accent/90"
            >
              {isLoading ? (
                <>
                  <svg
          ...
          <p className="mt-6 text-center text-sm text-pdt-neutral/60">
            ...
            <Link
              to="/register"
              className="font-medium text-pdt-accent underline-offset-4 hover:underline"
            >
              Sign up
            </Link>
          </p>
