  ...
  const integrations = [
    {
      name: 'GitHub',
      icon: (
        <svg className="w-8 h-8 sm:w-10 sm:h-10 text-[#FBFFFE]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
            {integrations.map((integration) => (
              <div key={integration.name} className="flex flex-col items-center gap-3">
                <div
                  className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-[#1B1B1E] border-2 border-[#F8C630] rounded-xl sm:rounded-2xl flex items-center justify-center"
                >
                  {integration.icon}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#F8C630]/30 mb-2 sm:mb-4">{item.step}</div>
